...
- [x] **Timeline Upload MP3** — Upload custom MP3 per segment on timeline toolbar. Backend validates duration (must fit segment time + 1s tolerance). Shows 🎤 icon on blocks with custom audio. (2026-04-05)
